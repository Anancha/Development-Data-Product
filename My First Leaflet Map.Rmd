...
```{r}
TDPKPopup <- c("<a href= 'https://www.truedigitalpark.com/home' >True Digital Park Bangkok TH<br><img src='https://s3-ap-southeast-1.amazonaws.com/truedigitalparkbucket/images/Overall-TrueDigitalPark.jpg' width='210' height='132'  alt='True Digital Park' title='True Digital Park'></a>")
map %>%
   addTiles() %>%
